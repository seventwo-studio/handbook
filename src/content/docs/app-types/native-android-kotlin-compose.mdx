...
Native Android projects live at `apps/android` in the monorepo. See [Monorepo Structure](/practices/monorepo/#appsandroid--native-android-kotlin--compose) for the full layout.
