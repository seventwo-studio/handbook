...
TanStack dashboards live at `apps/dashboard` in the monorepo. See [Monorepo Structure](/practices/monorepo/#appsdashboard--tanstack-dashboard) for the full layout.
